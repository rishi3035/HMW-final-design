...
- **Section 3 — Security Technology Matrix (`100vh`)**: Full-screen bidirectional Animated Beam network connecting battle-tested security engines (OWASP ZAP, Nuclei, Semgrep, Playwright, GitHub, BashCraft) to the central HMW Core.
