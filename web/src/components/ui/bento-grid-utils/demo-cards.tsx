...
export const AiAssistantDemo = () => (
  <div className="p-3.5 rounded-xl bg-black border border-neutral-800/80  text-xs space-y-1.5 text-neutral-300">
    ...
    <div className="text-cyan-400 flex items-center gap-1 text-xs">
...
export const MusicPlayerDemo = () => (
  <div className="flex items-center gap-3 p-3 rounded-xl bg-black border border-neutral-800/80">
    ...
    <div className="min-w-0 flex-1">
      ...
      <p className="text-xs text-neutral-400 ">24/7 DAST Canary</p>
    </div>
  </div>
);
...
export const NotificationsDemo = () => (
  <div className="space-y-1.5">
    <div className="p-2 rounded-lg bg-black border border-neutral-800/80 text-xs  text-emerald-400 flex items-center justify-between">
      <span>0 Critical CVEs</span>
      <span className="text-xs px-1.5 py-0.2 rounded bg-emerald-950 border border-emerald-500/20 text-emerald-400">
        Safe
      </span>
    </div>
  </div>
...
export const TerminalDemo = () => (
  <div className="p-3.5 rounded-xl bg-black border border-neutral-800/80  text-xs leading-relaxed text-slate-300">
  ...
  <div className="flex items-center gap-2">
    <div className="flex -space-x-2">
      {["R", "A", "H"].map((init, i) => (
        <div
          key={i}
          className="w-7 h-7 rounded-full bg-neutral-900 border border-neutral-700 flex items-center justify-center text-xs font-bold text-white "
        >
          {init}
        </div>
      ))}
    </div>
    <span className="text-xs  text-neutral-400">+4 DevSecOps seats</span>
  </div>
);

export const StorageDemo = () => (
  <div className="flex items-center justify-between p-2.5 rounded-xl bg-black border border-neutral-800/80  text-xs">
...
export const CalendarDemo = () => (
  <div className="p-3 rounded-xl bg-black border border-neutral-800/80 text-xs  text-neutral-300 flex items-center justify-between">
