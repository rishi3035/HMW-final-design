  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-12 sm:space-y-16">
        ...
        <div className="w-full max-w-7xl mx-auto rounded-3xl bg-[#030806]/85 backdrop-blur-xl border border-emerald-500/25 p-6 sm:p-8 shadow-[0_20px_50px_rgba(0,0,0,0.8),0_0_40px_rgba(22,136,99,0.15)] space-y-6 relative overflow-hidden">
          ...
          <div className="overflow-x-auto pb-3 pt-1 -mx-2 px-2">
            <div className="flex flex-col xl:flex-row items-stretch xl:items-center justify-between gap-3 xl:gap-2 min-w-full xl:min-w-[1340px]">
              {/* STAGE 1: YOUR APPLICATION */}
              <div className="w-full xl:w-[155px] shrink-0 p-3.5 rounded-xl bg-slate-900/90 border border-slate-700/80 shadow-md flex flex-col justify-between text-left h-[260px]">
              ...
              <div className="w-full xl:w-[165px] shrink-0 p-3.5 rounded-xl bg-gradient-to-b from-emerald-950/60 via-slate-900 to-emerald-950/40 border border-emerald-500/50 shadow-lg flex flex-col justify-between text-left h-[260px]">
                <div className="space-y-2.5">
                  <div className="flex items-center justify-between">
              ...
              <div className="w-full xl:w-[270px] shrink-0 p-3 rounded-xl bg-slate-950/90 border border-emerald-500/40 shadow-lg flex flex-col justify-between text-left h-[260px]">
                ...
                <div className="grid grid-cols-2 gap-1.5 py-1">
                  {/* Engine 1: ZAP */}
                  <div className="p-2 rounded-lg bg-slate-900 border border-emerald-500/30 flex flex-col justify-between space-y-1">
                    <div className="flex items-center justify-between">
                  ...
                  {/* Engine 2: Nuclei */}
                  <div className="p-2 rounded-lg bg-slate-900 border border-cyan-500/30 flex flex-col justify-between space-y-1">
                    <div className="flex items-center justify-between">
                      <span className="text-[11px] font-bold text-white flex items-center gap-1">
                  ...
                  {/* Engine 3: Semgrep */}
                  <div className="p-2 rounded-lg bg-slate-900 border border-amber-500/30 flex flex-col justify-between space-y-1">
                    <div className="flex items-center justify-between">
                      <span className="text-[11px] font-bold text-white flex items-center gap-1">
                  ...
                  {/* Engine 4: Playwright */}
                  <div className="p-2 rounded-lg bg-slate-900 border border-purple-500/30 flex flex-col justify-between space-y-1">
                    <div className="flex items-center justify-between">
                      <span className="text-[11px] font-bold text-white flex items-center gap-1">
                ...
                <span className="text-[9px] font-mono text-slate-500 text-center block pt-0.5">
              ...
              <div className="w-full xl:w-[155px] shrink-0 p-3.5 rounded-xl bg-slate-900/95 border border-slate-700 flex flex-col justify-between text-left h-[260px]">
                <div className="space-y-2.5">
                  <div className="flex items-center justify-between">
              ...
              <div className="w-full xl:w-[150px] shrink-0 p-3.5 rounded-xl bg-gradient-to-b from-emerald-950/50 to-slate-900 border border-emerald-500/60 shadow-md flex flex-col justify-between text-left h-[260px]">
                <div className="space-y-2.5">
                  <div className="flex items-center justify-between">
                    <div className="size-8 rounded-lg bg-emerald-500/20 border border-emerald-500/40 flex items-center justify-center text-emerald-400">
                ...
                <div className="space-y-2 text-center">
                  <div className="text-2xl font-mono font-black text-emerald-400 bg-emerald-950 border border-emerald-700/80 py-1 rounded-lg shadow-inner">
                    0–100
                  </div>
              ...
              <div className="w-full xl:w-[160px] shrink-0 p-3.5 rounded-xl bg-slate-950 border border-emerald-500/80 shadow-lg flex flex-col justify-between text-left h-[260px]">
                <div className="space-y-2.5">
                  <div className="flex items-center justify-between">
                    <div className="size-8 rounded-lg bg-emerald-500/20 border border-emerald-500/50 flex items-center justify-center text-emerald-400">
