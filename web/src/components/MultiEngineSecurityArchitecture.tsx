        ...
        <div className="w-full max-w-7xl mx-auto rounded-3xl bg-[#030806]/85 backdrop-blur-xl border border-emerald-500/25 p-4 sm:p-6 shadow-[0_20px_50px_rgba(0,0,0,0.8),0_0_40px_rgba(22,136,99,0.15)] space-y-3 sm:space-y-4 relative overflow-hidden shrink-0">
          ...
          <div className="overflow-x-auto pb-2 pt-1 -mx-2 px-2 scrollbar-thin">
            <div className="flex flex-col xl:flex-row items-stretch xl:items-center justify-between gap-2.5 xl:gap-2 min-w-full xl:min-w-[1300px]">
              ...
              {/* STAGE 3: THREE SPECIALIZED ENGINES */}
                ...
                <div className="flex flex-col gap-1.5 py-0.5">
                  ...
                  <div className="p-1.5 rounded-lg bg-slate-900 border border-emerald-500/30 flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        <span className="text-[10px] font-bold text-white block leading-tight">OWASP ZAP</span>
                        <span className="text-[8px] text-slate-400 block leading-tight">Runtime HTTP DAST probes</span>
                      </div>
                    </div>
                    <span className="text-[8px] font-mono px-1 py-0.2 rounded bg-emerald-500/10 text-emerald-400 border border-emerald-500/30 shrink-0">
                      DAST
                    </span>
                  </div>

                  {/* Engine 2: Nuclei */}
                  <div className="p-1.5 rounded-lg bg-slate-900 border border-cyan-500/30 flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <div className="size-6 rounded bg-cyan-500/10 flex items-center justify-center shrink-0">
                        <Bug className="size-3 text-cyan-400" />
                      </div>
                      <div>
                        <span className="text-[10px] font-bold text-white block leading-tight">Nuclei Engine</span>
                        <span className="text-[8px] text-slate-400 block leading-tight">5k+ CVE exploit templates</span>
                      </div>
                    </div>
                    <span className="text-[8px] font-mono px-1 py-0.2 rounded bg-cyan-500/10 text-cyan-400 border border-cyan-500/30 shrink-0">
                      CVE
                    </span>
                  </div>
                  ...
                  <div className="p-1.5 rounded-lg bg-slate-900 border border-amber-500/30 flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        <span className="text-[10px] font-bold text-white block leading-tight">Semgrep SAST</span>
                        <span className="text-[8px] text-slate-400 block leading-tight">AST code & token analysis</span>
                      </div>
                    </div>
                    <span className="text-[8px] font-mono px-1 py-0.2 rounded bg-amber-500/10 text-amber-400 border border-amber-500/30 shrink-0">
                      SAST
                    </span>
                  </div>
                </div>
