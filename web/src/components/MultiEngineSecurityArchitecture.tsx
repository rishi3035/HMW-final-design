      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full flex flex-col justify-center space-y-4 sm:space-y-6 my-auto">
        ...
        <div className="w-full max-w-7xl mx-auto rounded-3xl bg-[#030806]/85 backdrop-blur-xl border border-emerald-500/25 p-4 sm:p-6 shadow-[0_20px_50px_rgba(0,0,0,0.8),0_0_40px_rgba(22,136,99,0.15)] space-y-3 sm:space-y-4 relative overflow-hidden shrink-0">
          ...
          <div className="flex items-center justify-between border-b border-emerald-900/60 pb-3">
            ...
            <span className="text-xs  text-emerald-300 bg-emerald-950/70 border border-emerald-700/60 px-2.5 py-0.5 rounded">
            ...
            <div className="flex flex-col xl:flex-row items-stretch xl:items-center justify-between gap-2.5 xl:gap-2 min-w-full xl:min-w-[1300px]">
              ...
              <div className="w-full xl:w-[155px] shrink-0 p-3 rounded-xl bg-slate-900/90 border border-slate-700/80 shadow-md flex flex-col justify-between text-left h-[225px]">
                <div className="space-y-2.5">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-xs  text-emerald-400 font-bold px-1.5 py-0.5 rounded bg-emerald-500/10 border border-emerald-500/30">
                      01 • INPUT
                    </span>
                  </div>
                  <div>
                ...
                <div className="space-y-2">
                  <span className="text-xs  text-slate-300 border border-slate-800 px-2 py-0.5 rounded bg-slate-950 block text-center truncate">
                    Web • APIs • Endpoints
                  </span>
              ...
              <div className="w-full xl:w-[165px] shrink-0 p-3 rounded-xl bg-gradient-to-b from-emerald-950/60 via-slate-900 to-emerald-950/40 border border-emerald-500/50 shadow-lg flex flex-col justify-between text-left h-[225px]">
                ...
                <div className="space-y-1.5">
                  <span className="text-xs  text-emerald-300 bg-emerald-900/40 border border-emerald-700/50 px-2 py-0.5 rounded block text-center truncate">
                    Dispatcher Engine
                  </span>
              ...
              <div className="w-full xl:w-[270px] shrink-0 p-2.5 rounded-xl bg-slate-950/90 border border-emerald-500/40 shadow-lg flex flex-col justify-between text-left h-[225px]">
                ...
                <div className="grid grid-cols-2 gap-1.5 py-0.5">
                  ...
                  <div className="p-1.5 rounded-lg bg-slate-900 border border-emerald-500/30 flex flex-col justify-between space-y-0.5">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-xs  px-1 py-0.2 rounded bg-emerald-500/10 text-emerald-400 border border-emerald-500/30">
                        DAST
                      </span>
                    </div>
                  ...
                  <div className="p-1.5 rounded-lg bg-slate-900 border border-cyan-500/30 flex flex-col justify-between space-y-0.5">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-xs  px-1 py-0.2 rounded bg-cyan-500/10 text-cyan-400 border border-cyan-500/30">
                        CVE
                      </span>
                    </div>
                    <span className="text-[8.5px] text-slate-400 leading-tight">
                  ...
                  <div className="p-1.5 rounded-lg bg-slate-900 border border-amber-500/30 flex flex-col justify-between space-y-0.5">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-xs  px-1 py-0.2 rounded bg-amber-500/10 text-amber-400 border border-amber-500/30">
                        SAST
                      </span>
                    </div>
                    <span className="text-[8.5px] text-slate-400 leading-tight">
                  ...
                  <div className="p-1.5 rounded-lg bg-slate-900 border border-purple-500/30 flex flex-col justify-between space-y-0.5">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-xs  px-1 py-0.2 rounded bg-purple-500/10 text-purple-400 border border-purple-500/30">
                        Surface
                      </span>
                    </div>
                    <span className="text-[8.5px] text-slate-400 leading-tight">
                ...
                <span className="text-[8.5px]  text-slate-500 text-center block pt-0.5">
              ...
              <div className="w-full xl:w-[155px] shrink-0 p-3 rounded-xl bg-slate-900/95 border border-slate-700 flex flex-col justify-between text-left h-[225px]">
                ...
                <div className="space-y-1.5">
                  <span className="text-xs  text-emerald-400 font-bold bg-emerald-950/70 border border-emerald-800/50 px-2 py-0.5 rounded block text-center truncate">
                    Unified Schema
                  </span>
                  <p className="text-[9.5px] text-slate-400 leading-tight">
              ...
              <div className="w-full xl:w-[155px] shrink-0 p-3 rounded-xl bg-slate-900/95 border border-slate-700 flex flex-col justify-between text-left h-[225px]">
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-xs  text-cyan-400 font-bold px-1.5 py-0.5 rounded bg-cyan-500/10 border border-cyan-500/30">
                      05 • STAGE 2
                    </span>
                  </div>
                  <div>
                ...
                <div className="space-y-1.5">
                  <span className="text-xs  text-cyan-400 font-bold bg-cyan-950/70 border border-cyan-800/50 px-2 py-0.5 rounded block text-center truncate">
                    Exploitability AI
                  </span>
                  <p className="text-[9.5px] text-slate-400 leading-tight">
              ...
              <div className="w-full xl:w-[150px] shrink-0 p-3 rounded-xl bg-gradient-to-b from-emerald-950/50 to-slate-900 border border-emerald-500/60 shadow-md flex flex-col justify-between text-left h-[225px]">
                ...
                <div className="space-y-1.5 text-center">
                  <div className="text-xl  font-black text-emerald-400 bg-emerald-950 border border-emerald-700/80 py-1 rounded-lg shadow-inner">
                    0–100
                  </div>
              ...
              <div className="w-full xl:w-[155px] shrink-0 p-3 rounded-xl bg-slate-900/95 border border-slate-700 flex flex-col justify-between text-left h-[225px]">
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-xs  text-amber-400 font-bold px-1.5 py-0.5 rounded bg-amber-500/10 border border-amber-500/30">
                      07 • ACTION
                    </span>
                  </div>
                  <div>
                ...
                <div className="space-y-1.5">
                  <span className="text-xs  text-amber-400 font-bold bg-amber-950/70 border border-amber-800/50 px-2 py-0.5 rounded block text-center truncate">
                    1-Click Prompts
                  </span>
                  <p className="text-[9.5px] text-slate-400 leading-tight">
              ...
              <div className="w-full xl:w-[160px] shrink-0 p-3 rounded-xl bg-slate-950 border border-emerald-500/80 shadow-lg flex flex-col justify-between text-left h-[225px]">
                ...
                <div className="space-y-1.5">
                  <span className="text-xs  text-emerald-300 bg-emerald-950 border border-emerald-700 px-2 py-0.5 rounded block text-center font-bold truncate">
                    Risk Eliminated
                  </span>
