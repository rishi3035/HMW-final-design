        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-start">
          ...
          <div className="lg:col-span-7 space-y-6 text-left">
            ...
            <div className="space-y-3.5">
              ...
              <div
                className={cn(
                  "p-4 sm:p-5 rounded-2xl border transition-all duration-300 flex items-center justify-between gap-4",
                  currentTarget.score >= 85
                    ? "bg-[#0A1612] border-emerald-500/80 shadow-lg shadow-emerald-500/10 scale-[1.01]"
              ...
              >
                ...
                <span className="px-3 py-1 rounded-full text-[11px] font-mono font-bold bg-emerald-950/80 border border-emerald-500/40 text-emerald-400 shrink-0">
                  SAFE
                </span>
              </div>
              ...
              <div
                className={cn(
                  ...
                  currentTarget.score >= 70 && currentTarget.score < 85
                    ? "bg-[#18150A] border-yellow-500/80 shadow-lg shadow-yellow-500/10 scale-[1.01]"
                    : "bg-black border-neutral-800 hover:border-neutral-700"
                )}
              >
                <div className="flex items-center gap-3.5 sm:gap-4">
                ...
                <span className="px-3 py-1 rounded-full text-[11px] font-mono font-bold bg-yellow-950/80 border border-yellow-500/40 text-yellow-400 shrink-0">
                  REVIEW
                </span>
              </div>
              ...
              <div
                className={cn(
                  ...
                  currentTarget.score >= 50 && currentTarget.score < 70
                    ? "bg-[#1B110A] border-orange-500/80 shadow-lg shadow-orange-500/10 scale-[1.01]"
                    : "bg-black border-neutral-800 hover:border-neutral-700"
                )}
              >
                <div className="flex items-center gap-3.5 sm:gap-4">
                ...
                <span className="px-3 py-1 rounded-full text-[11px] font-mono font-bold bg-orange-950/80 border border-orange-500/40 text-orange-400 shrink-0">
                  RISK
                </span>
              </div>
              ...
              <div
                className={cn(
                  ...
                  currentTarget.score < 50
                    ? "bg-[#1D0B0D] border-red-500/80 shadow-lg shadow-red-500/10 scale-[1.01]"
                    : "bg-black border-neutral-800 hover:border-neutral-700"
                )}
              >
                <div className="flex items-center gap-3.5 sm:gap-4">
                ...
                <span className="px-3 py-1 rounded-full text-[11px] font-mono font-bold bg-red-950/80 border border-red-500/40 text-red-400 shrink-0">
                  BLOCKER
                </span>
              </div>
            </div>
              ...
              <div className="relative size-44 sm:size-48 flex items-center justify-center">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center text-center">
                  <div className="flex items-baseline justify-center">
                    ...
                    <span className="text-base sm:text-lg font-mono text-slate-400 font-bold ml-0.5">
                      /100
                    </span>
                  </div>
                  <span
                    className="text-[11px] font-mono font-bold mt-1 px-2 py-0.5 rounded border"
                    style={{
